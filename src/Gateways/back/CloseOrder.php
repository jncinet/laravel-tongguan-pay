...
class CloseOrder implements GatewayInterface
{
    const URL = 'http://tgjf.833006.biz/tgPosp/services/payApi/closeTradeOrder';
    ...
    {
        if (!array_key_exists('out_trade_no', $data) || !array_key_exists('trade_no', $data)) {
