...
class Refund implements GatewayInterface
{
    const URL = 'http://tgjf.833006.biz/tgPosp/services/payApi/refund';
    ...
    {
        if (!array_key_exists('refundMoney', $data) || !array_key_exists('trade_no', $data)) {
