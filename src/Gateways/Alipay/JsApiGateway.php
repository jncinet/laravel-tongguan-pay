...
{
    const URL = 'http://ipay.833006.net/tgPosp/services/payApi/zfbJspay';
    ...
    {
        if (!array_key_exists('buyer_id', $order) || !array_key_exists('notify_url', $order) || !array_key_exists('out_trade_no', $order) || !array_key_exists('total_amount', $order) || !array_key_exists('body', $order)) {
